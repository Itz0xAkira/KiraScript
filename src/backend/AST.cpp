...
namespace ns {
	...
	std::ostream& operator<<(std::ostream& ostream, const Statement* statement) {
		...
		case NodeType::VarDeclaration:
		{
			...
			printNodeStart("KiraDeclaration", true); 
		...
		{
			[[maybe_unused]] const NullLiteral* nullLiteral = dynamic_cast<const NullLiteral*>(statement); 
		...
		{
			[[maybe_unused]] const NumLiteral* numLiteral = dynamic_cast<const NumLiteral*>(statement); 
