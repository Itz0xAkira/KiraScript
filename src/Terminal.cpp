...
namespace ns {
	...
	void initkiraScriptMsg() {
		std::cout << "\nkiraScript Terminal - Created with <3 By 0xAkira (2024)\n\n";

		std::cout << "Imagine there is an ASCII art here\n\n";
	...
	void executeTerminal(const std::string& input) {
		...
		if (words[0] == "help") {
			std::cout << "\nlist of commands:\n\n"
				...
				" run [string] -> Runs a .ks script, if the file path is given\n"
