...
/*
	...
	To my future self... I am sorry but atleast you had a great sense of humor :3
...
namespace ns {
		...
		FuncValue* funcValue, FuncCall* funcCall, Scope* scope) 
	{
		...
		/*
				...
				Math built in functions [pow, sqrt, abs] but abs will be found @  552 
				since I want the functions to be chromaticlly as in the nativeFuncNames[]
				very dumb I know... but ODC :)
		...
		*/
		...
		/*
				...
				List Aka Array built in functions [len , append, at, set, pop]
	...
	RuntimeValue* evaluateAssignmentExpr(AssignmentExpr* assignmentExpr, Scope* scope) {
		if (assignmentExpr->assigne->nodeType != NodeType::Identifier)
			/* 
				...
				KiraScript::Invalid assigne referenced in assignment expression @ line 12
